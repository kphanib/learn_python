...
my_list = [random.randint(25,500) for num in range(200)] # replace the code to the left
print(my_list)
...
comparison = ("True" if my_new_tuple[0] == my_tuple_last_val else "False") # replace the code to the left
...
tuple_and_list_comp = True if my_other_tuple == my_list[-5:] else False # replace the code to the left
...
print(my_match) # replace the code to the left
